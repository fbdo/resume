...
** AutoScout24: Development of Frontend/Backend application using technologies as ReactJS, Typescript, Scala and AWS cloud. Development of data management process moving data from the data lake to Salesforce Marketing Cloud following GDPR directives.
